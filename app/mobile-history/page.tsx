  ...
  return (
    <div className="mobile-history">
      ...
      <div className="header">
        ...
        <h1 className="page-title">Mobile History</h1>
      ...
      <div className="content">
        <div className="history-section">
          <h2 className="section-title">History Coming Soon</h2>
          <p className="section-desc">Mobile transaction history interface will be implemented here</p>
        </div>
      </div>
      ...
      <div className="bottom-nav">
        ...
        <Link href="/mobile-history" className="nav-item active">
          <div className="nav-icon">⊞</div>
          <span>History</span>
        </Link>
